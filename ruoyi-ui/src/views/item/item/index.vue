<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="item description" prop="itemDescription">
        <el-input
          ...
          placeholder="请输入item description"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="itemList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="item picture" align="center" prop="itemPic" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="item picture" prop="itemPic">
          <el-input v-model="form.itemPic" placeholder="请输入item picture" />
        </el-form-item>
        <el-form-item label="item name" prop="itemName">
          <el-input v-model="form.itemName" placeholder="请输入item name" />
        </el-form-item>
        <el-form-item label="item price" prop="itemPrice">
          <el-input v-model="form.itemPrice" placeholder="请输入item price" />
        </el-form-item>
        <el-form-item label="item description" prop="itemDescription">
          <el-input v-model="form.itemDescription" placeholder="请输入item description" />
        </el-form-item>
